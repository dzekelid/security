...
created: "2018-02-26"
modified: "2018-02-26"
url: https://raw.githubusercontent.com/streamdata-gallery/security/master/_listings/google-cloud-key-management-service-kms/apis.yaml
...
- name: Google Cloud Key Management Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/security/master/_listings/google-cloud-key-management-service-kms/v1-resource-testiampermissions-post.md
x-common:
- type: x-change-log
