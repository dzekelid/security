...
created: "2018-03-24"
modified: "2018-03-24"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/security/master/_listings/akamai/apis.yaml
...
- name: Akamai API Promote a Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/security/master/_listings/akamai/config-media-security-v1-security-policyid-promote-put.md
- name: Akamai API Remove a Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/security/master/_listings/akamai/config-media-security-v1-security-policyid-promotedelete-delete.md
x-common:
- type: x-base
